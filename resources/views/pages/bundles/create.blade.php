                        ...
                        <form method="POST" action="{{ route('bundles.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                @if (auth()->user()->role == 'staff')
                                    ...
                                    <input type="text" class="form-control" value="{{ auth()->user()->branch->name }}"
                                        readonly>
                                @else
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <select name="items[0][variant_id]"
                                                    class="form-control select2 variant-select" required>
                                                    <option value="" selected disabled>Select Variant</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label>Bottle Size (ml)</label>
                                                <select name="items[0][bottle_id]"
                                                    class="form-control select2 bottle-size-select" required>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="text" name="items[0][harga]"
                                                    class="form-control harga-input" readonly>
                                            </div>
                                            <div class="col-md-2">
                                                <label>Harga Setelah Diskon</label>
                                                <input type="text" name="items[0][harga_setelah_diskon]"
                                                    class="form-control harga-diskon-input" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <button type="button" class="btn btn-secondary mt-3" id="add-item">Add Another
                                    Item</button>
                            </div>
                ...
                if (variant) {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            bottleSizeSelect.append(
                                '<option value="" selected disabled>Select Bottle Size</option>'
                                );
                            $.each(data, function(key, bottle) {
                                bottleSizeSelect.append(
                                    `<option value="${bottle.id}" data-harga="${bottle.harga_ml}">${bottle.bottle_size} ml</option>`
                                    );
                            });
