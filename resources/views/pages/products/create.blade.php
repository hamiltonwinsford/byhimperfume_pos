                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                @role('admin')
                                    ...
                                    <select class="form-control selectric @error('branch_id') is-invalid @enderror"
                                        name="branch_id" id="branch_id">
                                        <option value="">Choose Branch</option>
                                        @foreach ($branches as $branch)
                                            <option value="{{ $branch->id }}"
                                                @if (old('branch_id') == $branch->id) selected @endif>{{ $branch->name }} -
                                ...
                                @role('staff')
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ auth()->user()->branch->name }} - {{ auth()->user()->branch->address }}"
                                        disabled>
                                @endrole
                                ...
                                <select class="form-control selectric @error('category_id') is-invalid @enderror"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            data-fragrances="{{ $category->fragrances_status }}"
                                            @if (old('category_id') == $category->id) selected @endif>{{ $category->name }} -
                                            {{ $category->fragrances_status == 1 ? 'Is Fragrances' : 'Is Not Fragrances' }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('category_id')
                            ...
                            <div class="form-group" id="literContainer" style="display: none;">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text"
                                            class="form-control @error('fragrances_name') is-invalid @enderror"
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <input type="number"
                                            ...
                                            name="total_weight" value="{{ old('total_weight') }}" id="total_weight">
                                        @error('total_weight')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number"
                                            class="form-control @error('pump_weight') is-invalid @enderror"
                                            name="pump_weight" value="{{ old('pump_weight') }}" id="pump_weight">
                                        @error('pump_weight')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number"
                                            class="form-control @error('bottle_weight') is-invalid @enderror"
                                            name="bottle_weight" value="{{ old('bottle_weight') }}" id="bottle_weight">
                                        @error('bottle_weight')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text"
                                            class="form-control @error('gram_to_ml') is-invalid @enderror"
                                            name="gram_to_ml"
                                            value="{{ old('gram_to_ml', $product->fragrance->gram_to_ml ?? '') }}"
                                            id="gram_to_ml">
                                        @error('gram_to_ml')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text"
                                            class="form-control @error('ml_to_gram') is-invalid @enderror"
                                            name="ml_to_gram"
                                            value="{{ old('ml_to_gram', $product->fragrance->ml_to_gram ?? '') }}"
                                            id="ml_to_gram">
                                        @error('ml_to_gram')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number" class="form-control @error('gram') is-invalid @enderror"
                                            name="gram" value="{{ old('gram') }}" id="gram" readonly>
                                        @error('gram')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="number"
                                            class="form-control @error('milliliter') is-invalid @enderror"
                                            name="milliliter" value="{{ old('milliliter') }}" id="milliliter" readonly>
                                        @error('milliliter')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
