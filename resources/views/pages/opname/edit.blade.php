            ...
            <div class="card">
                <form action="{{ route('first_stock.update', $data) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>G to ML</label>
                            <input type="text" value="{{ $data->g_to_ml }}" class="form-control @error('g_to_ml')
                                is-invalid
                        ...
                        <div class="form-group">
                            <label>ML to G</label>
                            <input type="text" value="{{ $data->ml_to_g }}" class="form-control @error('ml_to_g')
                                is-invalid
