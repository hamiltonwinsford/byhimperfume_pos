...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="card">
                <form action="{{ route('bottle.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('bottle_name')}}" class="form-control @error('bottle_name')
                                is-invalid
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('bottle_size')}}" class="form-control @error('bottle_size')
                                is-invalid
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{old('bottle_type')}}" class="form-control @error('bottle_type')
                                is-invalid
